...
BENCHMARK_PROFILE_LOCKS: dict[str, dict[str, Any]] = {
    ...
    "m7_deeponet_plasma_pod": {
        "profile": "m7_deeponet_plasma_pod",
        "dimension": "2d_steady",
        "models": ["deeponet_plasma_pod"],
        "phi_mode": "direct",
        "axis_mode": "steady",
        "poisson_refine_iters": 0,
        "sensor_query_seed": None,
    ...
    "m7_geom_deeponet_pod": {
        "profile": "m7_geom_deeponet_pod",
        "dimension": "2d_steady",
        "models": ["geom_deeponet_pod"],
        "phi_mode": "direct",
        "axis_mode": "steady",
        "poisson_refine_iters": 0,
        "sensor_query_seed": None,
    ...
    "m7_cno_operator_unet": {
        "profile": "m7_cno_operator_unet",
        "dimension": "2d_steady",
        "models": ["cno_operator_unet"],
        "phi_mode": "direct",
        "axis_mode": "steady",
        "poisson_refine_iters": 0,
        "sensor_query_seed": None,
    ...
    "m7_geom_deeponet_siren_experimental": {
        "profile": "m7_geom_deeponet_siren_experimental",
        "dimension": "2d_steady",
        "models": ["geom_deeponet_siren"],
        "phi_mode": "direct",
        "axis_mode": "steady",
        "poisson_refine_iters": 0,
        "sensor_query_seed": None,
