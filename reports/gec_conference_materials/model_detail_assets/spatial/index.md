...
| `global_mlp` | `interp` | 13 | 0.2860 | 0.2811 | 0.3132 | 0.1695 | 0.2625 |
...
- [global_mlp](model_summaries/global_mlp.md) — representative seed `412`; interp × 4物性 × 5代表ケース

## 完全性

- requested / plotted models: `3` / `3`
- all-case metric rows: `39`
- selected model/split/case rows: `3`
- PNG/PDF pairs: `12`
- skipped models: `0`
...
- [publication_field_plots.csv](publication_field_plots.csv): 全12代表図のパスとrel.RMSE
