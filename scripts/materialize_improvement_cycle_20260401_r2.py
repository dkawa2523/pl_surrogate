"""Materialize benchmark fixtures for improvement cycle 2026-04-01 R2."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Materialize improvement-cycle R2 benchmark fixtures")
    parser.add_argument(
        "--matrix",
        type=Path,
    ...
    for exp in experiments:
        ...
        if not str(merged_bench.get("output_dir", "")).strip():
            merged_bench["output_dir"] = f"runs/improvement_cycle_20260401_r2/{exp_id}"
