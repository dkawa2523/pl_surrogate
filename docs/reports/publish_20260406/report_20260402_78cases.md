...
![r2 bar](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__plots__r2_dual_interp_extrap_bar.png)

### 3.2 dual vs extrap（Pareto）
![dual vs extrap](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__plots__dual_vs_extrap_scatter_pareto.png)

### 3.3 変数別 extrap ヒートマップ
![extrap heatmap](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__plots__extrap_r2_var_heatmap.png)
...
![all10 interp](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__all10__interp__spatial_fields_interp_mean_1cases_with_gt_grid.png)
- extrap mean（共通3ケース, GT付き）  
![all10 extrap](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__all10__extrap__spatial_fields_extrap_mean_3cases_with_gt_grid.png)

### 4.2 上位4モデル詳細（fno / ffno / coord_mlp_fourier / unetpp_attn）
- interp mean（3ケース, GT付き）  
![top4 interp](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__top4__interp__spatial_fields_interp_mean_3cases_with_gt_grid.png)
- interp diff vs fno  
![top4 interp diff](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__top4__interp__spatial_fields_interp_mean_3cases_diff_vs_fno.png)
- extrap mean（3ケース, GT付き）  
![top4 extrap](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__top4__extrap__spatial_fields_extrap_mean_3cases_with_gt_grid.png)
- extrap diff vs fno  
![top4 extrap diff](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__top4__extrap__spatial_fields_extrap_mean_3cases_diff_vs_fno.png)

### 4.3 DeepONet-POD と Geom-DeepONet-SIREN（2モデル比較）
`geom_deeponet_siren` は既存ケースと GT マッピングが直接合わないため、この比較は予測場のみです。

- interp mean（予測場）  
![pod geom interp](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__pod_geom__interp__spatial_fields_interp_mean_1cases_grid.png)
- extrap mean（予測場）  
![pod geom extrap](assets/report_20260402_78cases/docs__reports__report_20260402_78cases__spatial__pod_geom__extrap__spatial_fields_extrap_mean_3cases_grid.png)
