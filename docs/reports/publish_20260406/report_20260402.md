...
![r2 bar](assets/report_20260402/docs__reports__report_20260402__plots__r2_dual_interp_extrap_bar.png)

### 3.2 dual vs extrap（Pareto）
![dual vs extrap](assets/report_20260402/docs__reports__report_20260402__plots__dual_vs_extrap_scatter_pareto.png)

### 3.3 変数別 extrap ヒートマップ
![extrap heatmap](assets/report_20260402/docs__reports__report_20260402__plots__extrap_r2_var_heatmap.png)

## 4. 空間分布（GT付き）
### 4.1 成功12モデルの全体比較（mean 3 cases）
- interp:
![all12 interp](assets/report_20260402/docs__reports__report_20260402__spatial__all12__interp__spatial_fields_interp_mean_3cases_with_gt_grid.png)
- extrap:
![all12 extrap](assets/report_20260402/docs__reports__report_20260402__spatial__all12__extrap__spatial_fields_extrap_mean_3cases_with_gt_grid.png)

### 4.2 上位4モデル詳細（deeponet_pod/u_no/fno/coord_mlp_fourier）
- interp mean:
![top4 interp](assets/report_20260402/docs__reports__report_20260402__spatial__top4__interp__spatial_fields_interp_mean_3cases_with_gt_grid.png)
- interp diff vs deeponet_pod:
![top4 interp diff](assets/report_20260402/docs__reports__report_20260402__spatial__top4__interp__spatial_fields_interp_mean_3cases_diff_vs_deeponet_pod.png)
- extrap mean:
![top4 extrap](assets/report_20260402/docs__reports__report_20260402__spatial__top4__extrap__spatial_fields_extrap_mean_3cases_with_gt_grid.png)
- extrap diff vs deeponet_pod:
![top4 extrap diff](assets/report_20260402/docs__reports__report_20260402__spatial__top4__extrap__spatial_fields_extrap_mean_3cases_diff_vs_deeponet_pod.png)
